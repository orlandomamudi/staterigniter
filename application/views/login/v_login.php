...
<head>
  ...
  <!-- CSS Libraries -->
  <link rel="stylesheet" href="<?= base_url() ?>/assets/templates/backend/node_modules/bootstrap-social/bootstrap-social.css">

  <!-- Template CSS -->
  <link rel="stylesheet" href="<?= base_url() ?>/assets/templates/backend/assets/css/style.css">
  <link rel="stylesheet" href="<?= base_url() ?>/assets/templates/backend/assets/css/components.css">
</head>
      ...
      <div class="d-flex flex-wrap align-items-stretch">
        <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
          <div class="p-4 m-3 mt-5">
            <div class="mb-5">
              <h2 class="text-dark font-weight-normal"><span class="font-weight-bold">Staterigniter</span></h2>
            </div>
            ...
            <div class="text-center mt-5 text-small">
              Copyright &copy; Staterigniter
            </div>
          </div>
        </div>
        <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="<?= base_url() ?>/assets/templates/backend/assets/img/unsplash/login-bg.jpg">
